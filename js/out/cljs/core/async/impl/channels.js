...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t15435 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t15435 = (function (val,box,meta15436){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t15435.cljs$lang$type = true;
cljs.core.async.impl.channels.t15435.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t15435";
cljs.core.async.impl.channels.t15435.cljs$lang$ctorPrWriter = (function (this__4217__auto__,writer__4218__auto__,opt__4219__auto__){return cljs.core._write.call(null,writer__4218__auto__,"cljs.core.async.impl.channels/t15435");
});
cljs.core.async.impl.channels.t15435.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t15435.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15437){var self__ = this;
var _15437__$1 = this;return self__.meta15436;
});
cljs.core.async.impl.channels.t15435.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15437,meta15436__$1){var self__ = this;
var _15437__$1 = this;return (new cljs.core.async.impl.channels.t15435(self__.val,self__.box,meta15436__$1));
});
cljs.core.async.impl.channels.__GT_t15435 = (function __GT_t15435(val__$1,box__$1,meta15436){return (new cljs.core.async.impl.channels.t15435(val__$1,box__$1,meta15436));
});
}
return (new cljs.core.async.impl.channels.t15435(val,box,null));
});
...
cljs.core.async.impl.channels.MMC = (function (){var obj15439 = {};return obj15439;
})();
...
{}
while(true){
var taker_15440 = self__.takes.pop();if((taker_15440 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_15440))
{var take_cb_15441 = cljs.core.async.impl.protocols.commit.call(null,taker_15440);var val_15442 = (cljs.core.truth_((function (){var and__3628__auto__ = self__.buf;if(cljs.core.truth_(and__3628__auto__))
{return (cljs.core.count.call(null,self__.buf) > (0));
} else
{return and__3628__auto__;
}
})())?cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf):null);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_15441,val_15442,taker_15440,this$__$1){
return (function (){return take_cb_15441.call(null,val_15442);
});})(take_cb_15441,val_15442,taker_15440,this$__$1))
);
} else
{}
{
...
{} else
{var putter_15443 = self__.puts.pop();if((putter_15443 == null))
{} else
{var put_handler_15444 = putter_15443.handler;var val_15445 = putter_15443.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_15444))
{var put_cb_15446 = cljs.core.async.impl.protocols.commit.call(null,put_handler_15444);cljs.core.async.impl.protocols.commit.call(null,handler);
cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_15446,put_handler_15444,val_15445,putter_15443,_,retval,this$__$1){
return (function (){return put_cb_15446.call(null,true);
});})(put_cb_15446,put_handler_15444,val_15445,putter_15443,_,retval,this$__$1))
);
if(cljs.core.reduced_QMARK_.call(null,self__.add_BANG_.call(null,self__.buf,val_15445)))
...
{var taker_15447 = self__.takes.pop();if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_15447))
{var take_cb_15448 = cljs.core.async.impl.protocols.commit.call(null,taker_15447);var val_15449__$1 = cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_15448,val_15449__$1,taker_15447,done_QMARK_,closed__$1,this$__$1){
return (function (){return take_cb_15448.call(null,val_15449__$1);
});})(take_cb_15448,val_15449__$1,taker_15447,done_QMARK_,closed__$1,this$__$1))
);
} else
{{
continue;
...
var putter_15450 = self__.puts.pop();if((putter_15450 == null))
{} else
{var put_handler_15451 = putter_15450.handler;var val_15452 = putter_15450.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_15451))
{var put_cb_15453 = cljs.core.async.impl.protocols.commit.call(null,put_handler_15451);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_15453,put_handler_15451,val_15452,putter_15450,this$__$1){
return (function (){return put_cb_15453.call(null,true);
});})(put_cb_15453,put_handler_15451,val_15452,putter_15450,this$__$1))
);
} else
{{
continue;
...
return (function() {
var G__15458 = null;
var G__15458__1 = (function (buf__$1){try{return add_BANG_.call(null,buf__$1);
}catch (e15456){var t = e15456;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
var G__15458__2 = (function (buf__$1,val){try{return add_BANG_.call(null,buf__$1,val);
}catch (e15457){var t = e15457;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
G__15458 = function(buf__$1,val){
switch(arguments.length){
case 1:
return G__15458__1.call(this,buf__$1);
case 2:
return G__15458__2.call(this,buf__$1,val);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__15458.cljs$core$IFn$_invoke$arity$1 = G__15458__1;
