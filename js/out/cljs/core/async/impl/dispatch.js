...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_15429 = (0);while(true){
var m_15430 = cljs.core.async.impl.dispatch.tasks.pop();if((m_15430 == null))
{} else
{m_15430.call(null);
if((count_15429 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__15431 = (count_15429 + (1));
count_15429 = G__15431;
continue;
}
} else
{}
