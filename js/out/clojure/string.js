...
{var pred__15569 = cljs.core._EQ_;var expr__15570 = limit;if(cljs.core.truth_(pred__15569.call(null,(1),expr__15570)))
...
{var ch = s.charAt(index);var temp__4124__auto___15576 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___15576))
{var replacement_15577 = temp__4124__auto___15576;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_15577)));
} else
{buffer.append(ch);
}
{
