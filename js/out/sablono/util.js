...
sablono.util.ToString = (function (){var obj15588 = {};return obj15588;
})();
sablono.util.to_str = (function to_str(x){if((function (){var and__3628__auto__ = x;if(and__3628__auto__)
...
{var x__4277__auto__ = (((x == null))?null:x);return (function (){var or__3640__auto__ = (sablono.util.to_str[goog.typeOf(x__4277__auto__)]);if(or__3640__auto__)
{return or__3640__auto__;
} else
{var or__3640__auto____$1 = (sablono.util.to_str["_"]);if(or__3640__auto____$1)
...
sablono.util.ToURI = (function (){var obj15590 = {};return obj15590;
})();
sablono.util.to_uri = (function to_uri(x){if((function (){var and__3628__auto__ = x;if(and__3628__auto__)
...
{var x__4277__auto__ = (((x == null))?null:x);return (function (){var or__3640__auto__ = (sablono.util.to_uri[goog.typeOf(x__4277__auto__)]);if(or__3640__auto__)
{return or__3640__auto__;
} else
{var or__3640__auto____$1 = (sablono.util.to_uri["_"]);if(or__3640__auto____$1)
{return or__3640__auto____$1;
} else
...
as_str.cljs$lang$applyTo = (function (arglist__15591){
var xs = cljs.core.seq(arglist__15591);
...
{var vec__15593 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__15593,(0),null);var words = cljs.core.nthnext.call(null,vec__15593,(1));if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
{var ks = cljs.core.keys.call(null,m);var kmap = cljs.core.zipmap.call(null,ks,cljs.core.map.call(null,sablono.util.camel_case,ks));var G__15595 = clojure.set.rename_keys.call(null,m,kmap);var G__15595__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__15595,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),camel_case_keys):G__15595);return G__15595__$1;
} else
{return m;
}
});
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__15596_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__15596_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__15596_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_.call(null,p1__15596_SHARP_))
...
merge_with_class.cljs$lang$applyTo = (function (arglist__15597){
var maps = cljs.core.seq(arglist__15597);
...
*/
sablono.util.normalize_element = (function normalize_element(p__15602){var vec__15605 = p__15602;var tag = cljs.core.nth.call(null,vec__15605,(0),null);var content = cljs.core.nthnext.call(null,vec__15605,(1));if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__15606 = sablono.util.match_tag.call(null,tag);var tag__$1 = cljs.core.nth.call(null,vec__15606,(0),null);var id = cljs.core.nth.call(null,vec__15606,(1),null);var class$ = cljs.core.nth.call(null,vec__15606,(2),null);var tag_attrs = sablono.util.compact_map.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"class","class",-2030961996),class$], null));var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
...
goog.Uri.prototype.sablono$util$ToString$to_str$arity$1 = (function (x){var x__$1 = this;if(cljs.core.truth_((function (){var or__3640__auto__ = x__$1.hasDomain();if(cljs.core.truth_(or__3640__auto__))
{return or__3640__auto__;
} else
