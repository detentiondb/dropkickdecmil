...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_15352 = (0);while(true){
if((i_15352 < arr.length))
{(arr[i_15352] = null);
{
...
{var i_15359 = (self__.level + (1));while(true){
if((i_15359 <= (new_level + (1))))
{(update[i_15359] = self__.header);
{
var G__15360 = (i_15359 + (1));
i_15359 = G__15360;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_15361 = (0);while(true){
if((i_15361 <= self__.level))
{var links_15362 = (update[i_15361]).forward;if(((links_15362[i_15361]) === x__$1))
{(links_15362[i_15361] = (x__$1.forward[i_15361]));
{
var G__15363 = (i_15361 + (1));
i_15361 = G__15363;
continue;
}
} else
{{
var G__15364 = (i_15361 + (1));
i_15361 = G__15364;
continue;
}
}
