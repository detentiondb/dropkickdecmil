...
sablono.util.ToString = (function (){var obj15591 = {};return obj15591;
})();
...
sablono.util.ToURI = (function (){var obj15593 = {};return obj15593;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__15594){
var xs = cljs.core.seq(arglist__15594);
...
{var vec__15596 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__15596,(0),null);var words = cljs.core.nthnext.call(null,vec__15596,(1));if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
{var ks = cljs.core.keys.call(null,m);var kmap = cljs.core.zipmap.call(null,ks,cljs.core.map.call(null,sablono.util.camel_case,ks));var G__15598 = clojure.set.rename_keys.call(null,m,kmap);var G__15598__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__15598,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),camel_case_keys):G__15598);return G__15598__$1;
} else
{return m;
}
});
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__15599_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__15599_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__15599_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_.call(null,p1__15599_SHARP_))
{return p1__15599_SHARP_;
} else
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__15599_SHARP_], null);
...
merge_with_class.cljs$lang$applyTo = (function (arglist__15600){
var maps = cljs.core.seq(arglist__15600);
...
* CSS classes.
*/
sablono.util.match_tag = (function match_tag(s){var matches = cljs.core.re_seq.call(null,/[#.]?[^#.]+/,cljs.core.name.call(null,s));var vec__15604 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,("Can't match CSS tag: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));var tag_name = cljs.core.nth.call(null,vec__15604,(0),null);var names = cljs.core.nth.call(null,vec__15604,(1),null);return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__15604,tag_name,names){
return (function (p1__15601_SHARP_){return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__15601_SHARP_));
});})(matches,vec__15604,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__15604,tag_name,names){
return (function (p1__15602_SHARP_){return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__15602_SHARP_));
});})(matches,vec__15604,tag_name,names))
,names)))], null);
});
/**
...
*/
sablono.util.normalize_element = (function normalize_element(p__15605){var vec__15608 = p__15605;var tag = cljs.core.nth.call(null,vec__15608,(0),null);var content = cljs.core.nthnext.call(null,vec__15608,(1));if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__15609 = sablono.util.match_tag.call(null,tag);var tag__$1 = cljs.core.nth.call(null,vec__15609,(0),null);var id = cljs.core.nth.call(null,vec__15609,(1),null);var class$ = cljs.core.nth.call(null,vec__15609,(2),null);var tag_attrs = sablono.util.compact_map.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"class","class",-2030961996),class$], null));var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
